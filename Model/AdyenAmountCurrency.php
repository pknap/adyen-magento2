...
class AdyenAmountCurrency
{
    ...
    public function getAmountIncludingTaxWithDiscount(bool $applyTaxAfterDiscount = false)
    {
        if ($this->getDiscountTaxCompensationAmount() > 0 || $applyTaxAfterDiscount === false) {
